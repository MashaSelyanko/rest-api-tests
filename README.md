...
<p align="center"><a href="https://reqres.in/"><img src="images/logo/reqres.png" align="center"  height="150"  alt="reqres"/></a></p>
...
- Негативный тест - отправка невалидного JSON при создании
- Негативный тест - создание пользователя без авторизации
- Позитивный тест - частичное обновление пользователя
- Позитивный тест - получение списка пользователей
- Позитивный тест- полное обновление пользователя
- Позитивный тест - удаление пользователя


## <img alt="Jenkins" height="25" src="images/logo/Jenkins.svg" width="25"/> Сборка в [Jenkins]
**(https://jenkins.qa.guru/job/41_MashaSelyanko_proect2/)**
...
<p align="center">  
<img src="images/screen/report.png" width="850">  
</p>  

## Сьюты

<p align="center">  
<img title="Allure Tests" src="images/screen/suites2.png" width="850">  
</p>
...
<p align="center">  
<img title="Allure Graphics" src="images/screen/TestOps.png" width="850">   
</p>
<p align="center">  
<img title="Allure Graphics" src="images/screen/тест-кейсы.png" width="850">   
</p>
